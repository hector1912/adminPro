      ...
      <div id="content">
        ...
        <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Registrar Nuevo Proyecto</h1>
              </div>
              <form class="user" action="Modelos/insert_proy.php" method="post">
                ...
                <div class="form-group row">
                  ...
                  <select class="form-control" id="estado" name="estado">
	                    	...
	                    	<?php
		                    	$Estado=new Allconsultas();
								          $lista=$Estado->consultEstado($con);
								          foreach($lista['items'] as $item) {
									        echo "<option value=".$item['idE'].">".$item['nombre']."</option>";	
								          } 
	                    	?>
	                    </select>
                  </div>
